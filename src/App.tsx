...
const App = () => {
  ...
  const handleDownloadPDF = async () => {
    ...
    spacer.style.cssText = 'height:320px;'; // colchón para evitar cortes de última sección
    ...
    try {
      ...
      const margin = 48;       // más margen para no cortar títulos (Idiomas)
      const minAdvance = 120;  // avance mínimo entre páginas
      ...
      while (true) {
        ...
        // Preferimos cortar justo antes del inicio de sección
